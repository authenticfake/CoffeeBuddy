...
## Vision
CoffeeBuddy delivers a focused, outcome-driven solution that solves a real user pain with a lightweight, testable scope. The project is AI-assisted but human-orchestrated.
