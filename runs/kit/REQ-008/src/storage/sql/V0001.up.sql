...
CREATE TABLE IF NOT EXISTS runs (
    ...
    runner_user_id UUID REFERENCES users(id) ON DELETE SET NULL,
...
CREATE INDEX IF NOT EXISTS idx_channel_admin_actions_channel ON channel_admin_actions (channel_id);
